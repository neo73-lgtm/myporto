...
const translations = {
  ...
  admin: { login: 'Masuk Admin', email: 'Email', password: 'Kata Sandi', signIn: 'Masuk', dashboard: 'Dashboard', personalInfo: 'Data Pribadi', projects: 'Proyek', experience: 'Pengalaman', education: 'Pendidikan', skills: 'Keahlian', testimonials: 'Testimoni', save: 'Simpan', saving: 'Menyimpan...', saved: 'Tersimpan!', logout: 'Keluar', add: 'Tambah', edit: 'Edit', delete: 'Hapus', cancel: 'Batal', confirm: 'Konfirmasi', noData: 'Tidak ada data', loading: 'Memuat...', projectUrl: 'URL Proyek', autoThumbnail: 'Thumbnail Otomatis', uploadImage: 'Upload Gambar' },
};
